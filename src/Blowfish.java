...
public class Blowfish {
    ...
    public  long encrypt(long word){
        ...
        long result = (((long)xL) <<32)|(((long)xR)&(0xFFFFFFFFL));
        return result;
    }
    ...
    protected void xorPArray(byte[] key){
        ...
        for(int i=0; i<P.length; i++){
            ...
            key32 = ((((int)key[keyIndex]) << 24)&0xFF000000) |
                    (((int)(key[(keyIndex+1) %key.length]) << 16)&0x00FF0000) |
                    (((int)(key[(keyIndex+2) %key.length]) << 8) &0x0000FF00) |
                    (((int)(key[(keyIndex+3) %key.length]))&0xFF);
            keyIndex = 4+keyIndex;
